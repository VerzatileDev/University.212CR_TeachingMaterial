...
(IN THIS CASE) TELL OPENGL THAT PART (FIRST HALF) OF THE BUFFER (BUFFERSUBDATA) IS FOR VERTICES		
	AND PLACE THE VERTEX DATA IN THAT HALF
(IN THIS CASE) TELL OPENGL THAT PART (SECOND HALF) OF THE BUFFER (BUFFERSUBDATA) IS FOR COLOURS		
	AND PLACE THE COLOUR DATA IN THAT HALF

(IN THIS CASE) TELL OPENGL HOW MANY THINGS MAKE UP A VERTEX POSITION AND WHERE THIS STARTS			
(IN THIS CASE) TELL OPENGL HOW MANY THINGS MAKE UP A VERTEX COLOUR AND WHERE THIS STARTS			
